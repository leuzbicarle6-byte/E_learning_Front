  ...
  return (
    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-[#0a192f]/80 backdrop-blur-md border-b border-white/5">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <Link
          to={"/login"}
          className="px-4 py-2 rounded-xl border border-blue-400 bg-linear-to-tr from-indigo-600 to-indigo-500 text-white shadow-lg shadow-indigo-900/20 transition-colors cursor-pointer animate-pulse"
        >
